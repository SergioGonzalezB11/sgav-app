<?php
    ...
    class LivingPlace{
        ...
        protected static $columnsTbl=['id_living','id_person','id_city','rooms_living','bathrooms_living','kitchen_living','tvroom','patio_living','pool_living','barbecue_living','image_living','id_typehouse'];
        private $id_living;
        private $id_person;
        private $id_city;
        ...
        public function loadAllData(){
            $sql = "SELECT id_living,id_person,id_city,rooms_living,bathrooms_living,kitchen_living,tvroom,patio_living,pool_living,barbecue_living,image_living,id_typehouse FROM living_place";
            $stmt= self::$conn->prepare($sql);
            $stmt->execute();
        ...
        public function loadByIdData($id){
            $sql = "SELECT id_living,id_person,id_city,rooms_living,bathrooms_living,kitchen_living,tvroom,patio_living,pool_living,barbecue_living,image_living,id_typehouse FROM living_place WHERE id_living = :id_living";
            $stmt= self::$conn->prepare($sql);
